    ...
    { 
        ...
        }elseif(isset($_POST["btnAddFormacao"]))
        {
            ...
            date('Y-m-d', strtotime($_POST["txtFimFA"])), $_POST["txtDescFA"], 
        ...
        elseif(isset($_POST["btnAddEP"]))
        {
            ...
            date('Y-m-d', strtotime($_POST["txtFimEP"])), $_POST["txtEmpEP"], $_POST["txtDescEP"], 
            unserialize($_SESSION['Usuario'])->getID()) != false)
            {           
                include_once '../View/cadastroRealizado.php';
            }
        ...
        elseif(isset($_POST["btnAddOF"]))
        {
            ...
            if($fController->inserir(date('Y-m-d', strtotime($_POST['txtInicioOF'])),
             date('Y-m-d', strtotime($_POST["txtFimOF"])), $_POST["txtDescOF"], 
             unserialize($_SESSION['Usuario'])->getID()) != false)
            {           
                include_once '../View/cadastroRealizado.php';
            }
